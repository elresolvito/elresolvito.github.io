...
const catalogo = {
  productos: [
    ...
    { id: 21, name: "Fritos", price: 200, image: "https://i.postimg.cc/GhqTCs0B/fritos.jpg", description: "Crujientes frituras.", specificDetails: "Paquete individual", category: "Confituras", department: "mercado", status: "available", hasBoxOption: false, weight: 0.05 },
    ...
    { id: 24, name: "Pelly de Queso", price: 500, image: "https://i.postimg.cc/Zq1yQkGV/pelly.jpg", description: "Sabor a queso.", specificDetails: "Paquete de 115g", category: "Confituras", department: "mercado", status: "available", hasBoxOption: false, weight: 0.12 },
    { id: 25, name: "Ron Capitán Cortez", price: 1500, image: "https://i.postimg.cc/xCzzpvCX/ron_capitan_cortez.jpg", description: "Ron brasileño.", specificDetails: "Botella de 965 ml", category: "Líquidos", department: "mercado", status: "available", hasBoxOption: false, weight: 1.5 },
    { id: 26, name: "Sorbeto Renata", price: 300, image: "https://i.postimg.cc/Wb6CbTSq/sorbeto-renata.jpg", description: "Dulce sabor a frutas.", specificDetails: "Paquete de 115g", category: "Confituras", department: "mercado", status: "available", hasBoxOption: false, weight: 0.15 },
    { id: 27, name: "Mermelada Fresa", price: 600, image: "https://i.postimg.cc/Kvd5ZYXS/mermelada.jpg", description: "Mermelada de fresa.", specificDetails: "Frasco de 200g", category: "Mercado", department: "mercado", status: "available", hasBoxOption: false, weight: 0.2 },

    // --- ROPA ---
    { id: 101, name: "Pullover Nike Dry", price: 2500, image: "https://via.placeholder.com/300x300?text=Pullover", description: "Algodón transpirable.", specificDetails: "Tallas S, M, L", category: "Hombre", department: "ropa", status: "available", hasBoxOption: false, weight: 0.2 },
    { id: 102, name: "Sandalias de Verano", price: 1800, image: "https://via.placeholder.com/300x300?text=Sandalias", description: "Cómodas y resistentes.", specificDetails: "Tallas 36-40", category: "Mujer", department: "ropa", status: "available", hasBoxOption: false, weight: 0.4 },

    // --- ELECTRO ---
    { id: 201, name: "Olla Reina", price: 25000, image: "https://via.placeholder.com/300x300?text=Olla+Reina", description: "Olla de presión eléctrica.", specificDetails: "5 Litros", category: "Cocina", department: "electro", status: "available", hasBoxOption: false, weight: 3.5 },
    { id: 202, name: "Batidora de Mano", price: 4500, image: "https://via.placeholder.com/300x300?text=Batidora", description: "Ideal para jugos.", specificDetails: "3 velocidades", category: "Cocina", department: "electro", status: "available", hasBoxOption: false, weight: 1.2 }
  ],
